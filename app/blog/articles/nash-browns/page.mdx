...
<ArticleSeo post={postMetadata} slug="nash-browns" />
...
export const featureImage = "/hippy-hokusai-logo.png";
export const neovim = "/blog/nash-browns/neovim.gif";
...
export const relatedArticleOne = '/blog/articles/frigga-tempreture-logger';
export const relatedArticleTwo = '/blog/articles/surviving-winter-in-the-tune-m1';
export const relatedArticleThree = '/blog/articles/japan-april-2026';

<MdxLayout>

<TLDR
text="My personal website that I use as a creative outlet and to publish art! Everything that you see on the blog was written or created by me. That includes all of the writing and art; even the website was written by me using some of my favorite technologies." />
...
### Tech Stack
The tech stack for this site is pretty much just Next.js, React, and MDX. I use a few libraries but try to keep it to a minimum.
...
<CenteredImage image={neovim} altText={'Neovim Gif'}  width={500} />
