...
export const postMetadata = {
    ...
    thumbnail: 'https://firebasestorage.googleapis.com/v0/b/nash-browns.firebasestorage.app/o/tune-roof-insulation%2Ffeature-image.JPEG?alt=media&token=c049372f-b403-4359-82b2-0934d9bae26d',
    thumbnailIllustration: 'https://firebasestorage.googleapis.com/v0/b/nash-browns.firebasestorage.app/o/tune-roof-insulation%2Fhippy-hokusai-feature-image.jpg?alt=media&token=053bdf5a-1d8c-45c5-8072-b72edcf4d8f3',
    description: "Discover how to insulate your Tune M1 camper roof with this comprehensive DIY guide. Learn about the best materials, tools, and step-by-step installation process to improve temperature control, reduce condensation, and enhance comfort in all seasons. Perfect for camper van owners seeking better insulation and energy efficiency.",
    keywords: ['Tune M1 roof insulation', 'DIY camper insulation', 'camper van temperature control', 'camper insulation guide', 'reduce camper condensation', 'energy efficient camper', 'roof insulation installation', 'truck camper upgrades', 'foam insulation panels', 'reflective insulation', 'outdoor carpet insulation', 'camper van build', 'van life tips'],
    tags: ['Tune M1', 'Roof Insulation', 'DIY Guide', 'Cold Weather', 'Temperature Control'],
    isActive: true,
};
...
<ArticleSeo post={postMetadata} slug="tune-roof-insulation" />

import { MdxLayout, MdxTableWraper } from '@/components/blog/mdx-layout';
...
export const featureImage = "https://firebasestorage.googleapis.com/v0/b/nash-browns.firebasestorage.app/o/tune-roof-insulation%2Ffeature-image.JPEG?alt=media&token=c049372f-b403-4359-82b2-0934d9bae26d";
export const carpet = "https://firebasestorage.googleapis.com/v0/b/nash-browns.firebasestorage.app/o/tune-roof-insulation%2Fcarpet.gif?alt=media&token=3987f7f3-a018-40b2-abe7-c09f8efe6542";
export const carpetMenards = "https://firebasestorage.googleapis.com/v0/b/nash-browns.firebasestorage.app/o/tune-roof-insulation%2Fcarpet.JPEG?alt=media&token=6f749494-ca2a-4b43-b239-d9d94275ff95";
export const measurements = "https://firebasestorage.googleapis.com/v0/b/nash-browns.firebasestorage.app/o/tune-roof-insulation%2Fmeasurements.PNG?alt=media&token=773e33a3-132b-475f-8e8b-e732adafae6d";
...
<MdxTableWraper>
    ...
    | 1 Roll    | Outdoor Carpet            | 8' X 12'             | $55.86 (Total)    |  [Shop Now][3]     | [Shop Now][2]     | <OutdoorCarpet title={'Shop Now'}/>            | 
    | 3 Cans    | Spray Adhesive             | Hi-Strength 90       | $15.66 (Each)     |  [Shop Now][4]     | [Shop Now][2]     | <HiStrengthAdhesive title={'Shop Now'}/>       | 
...
<MdxTableWraper>
    ...
    | :-------:    | :-------------------------------------------------------------:|:-------------------: | :--------------------------------------: |
    | Large Square | Any type of large straight edge will work                       | [HomeDepot][8]       |  <DryWallTSquare title={'Shop Now'}/>    | 
    | Speed Square | Small square for making notches                                | [HomeDepot][9]       |  <SpeedSquare title={'Shop Now'}/>       | 
    | Hot Knife    | Makes cutting way faster and cleaner                           | [Harbor Freight][10] |  <HotKnife title={'Shop Now'}/>          | 
    | Multi-Tool   | A good option if you already have one. The hot knife is better! | [HomeDepot][11]      |  <ElectricMultiTool title={'Shop Now'}/> | 
    | Scissors     | Sharp ones!                                                    | [HomeDepot][12]      |  <Scissors title={'Shop Now'}/>          | 
</MdxTableWraper>
...
<CenteredImage image={measurements} altText={'Tune M1 roof insulation panel measurements'} title={'Measurements'} width={'500'} />
You will need one 4x8 sheet of foam for each indent. If you have a longer truck this may vary!
...
<TwoColumn>
    <div className={'w-full sm:w-1/2'}>
        <CenteredImage image={carpet} altText={'Menards Carpet'} title={'Menards Product'} width={'500'} />
    </div>
    <div className={'w-full sm:w-1/2'}>
        <CenteredImage image={carpetMenards} altText={'Menards Carpet'} title={'Menards Product'} width={'500'} />
    </div>
</TwoColumn>
...
## Testing
The panels only add minimal performance increases over the stock roof in cold weather conditions. You can read more here: [Tune Cold Weather Performance][7].
The camper was noticeably darker after installing the panels. A plus if that's what you're into!
...
[7]: /blog/articles/tune-cold-weather-performance
