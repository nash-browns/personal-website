...
<CenteredImage image={measurements} altText={'Tune M1 roof insulation panel measurements'} title={'Measurements'} width={'500'} height={'500'} />
...
<TwoColumn>
    <div className={'w-full sm:w-1/2'}>
        <CenteredImage image={carpet} altText={'Menards Carpet'} title={'Menards Product'} width={'500'} height={'500'} />
    </div>
    <div className={'w-full sm:w-1/2'}>
        <CenteredImage image={carpetMenards} altText={'Menards Carpet'} title={'Menards Product'} width={'500'} height={'500'} />
    </div>
</TwoColumn>
