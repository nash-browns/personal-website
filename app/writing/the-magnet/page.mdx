...
export const postMetadata = {
    ...
    description: "A night in Washington, D.C., leads to an unexpected bar, fleeting friendships, and reflections on life as a traveler.",
    keywords: ['Washington DC', 'travel writing', 'short story', 'Nash Bostwick'],
